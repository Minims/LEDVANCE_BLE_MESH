...
- Compile pour mon esp32-C6 avec la yaml dans @prod/
...
- Pour ameliorer la gestion des lampes, utilise RANGE_GET sur la luminosité et la temperature histoire de revoir la plage de fonctionnement des lampes pour ces actions (il existe une branch generic_sigmesh qui implemente cette fonction correctement, mais pas dans esphome)
- Attention il peut etre necessaire d'inverser la plage de fonctionnement des lampes.
